...
status.QUEST_DARK_MEM_STD_LOCKED = "Quest / Dark Mem STD Locked"
status.QUEST_DARK_MEM_EXP_LOCKED = "Quest / Dark Mem EXP Locked"
status.QUEST_DARK_MEM_MST_LOCKED = "Quest / Dark Mem MST Locked"
...
status.QUEST_WAIT_DARK_MEM_COMPLETED = "Quest / Wait Dark Mem Complete"
