...
function action_arena.arena_in_battle()
    ...
    base.check_image(images.arena_in_battle_indicator, nil, function()
        base.click_delay(coords.arena_p1_s1, configs.pvp_skill_period)
        base.click_delay(coords.arena_p1_s2, configs.pvp_skill_period)
        base.click_delay(coords.arena_p2_s1, configs.pvp_skill_period)
        base.click_delay(coords.arena_p2_s2, configs.pvp_skill_period)
        base.click_delay(coords.arena_p3_s1, configs.pvp_skill_period)
        base.click_delay(coords.arena_p3_s2, configs.pvp_skill_period)
    end)
